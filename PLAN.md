...
Stable setup, operations, endpoint, deploy, health-monitor, and backfill documentation now lives in [`README.md`](README.md). This file is the incident log, rollout record, and forward plan.
...
Stable architecture, operations, endpoint, deploy, health-monitor, and backfill docs were moved to [`README.md`](README.md). Keep this file focused on incident notes, rollout history, and planning.
